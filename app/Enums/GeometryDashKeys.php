...
enum GeometryDashKeys: int
{
	...
	public const GeometryDashKeys LIKE = GeometryDashKeys::LIKE_AND_RATE;
	public const GeometryDashKeys RATE = GeometryDashKeys::LIKE_AND_RATE;
